            ...
            <div className="max-w-screen-xl mx-auto px-6 xl:px-5 py-[9%] lg:flex h-full">
                <div className="w-full md:w-[90%] lg:w-[64%]">
                    ...
                    <div className="my-12">
                        ...
                        <p className="text-base sm:text-lg text-[#5d5d5d] mb-8">Our Single Cabin is the pinnacle of luxury. This suite offers breathtaking views of Mountain Dreamers Lodge from three bays.</p>
                    ...
                    <div className="py-10 px-9 border box-shadow rounded-3xl">
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                <p className="font-bold text-xl md:text-3xl">$ 99.00 USD</p>
