...
const Micro_cabin  = () => {
    ...
    return(
        <div className="text-black font-sans w-full">
            <div className="flex flex-col h-[75vh] md:h-screen micro-header justify-end">
                <div className="flex  xl:px-5 mb-20">
                    <div className="text-white px-6 md:w-[85%] lg:w-[60%]">
                        <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl mb-8  ">Micro cabin</h1>
            ...
            <div className="max-w-screen-xl mx-auto px-6 xl:px-5 py-[9%] lg:flex h-full">
                <div className="w-full md:w-[90%] lg:w-[64%]">
                    <div className="w-full space-y-3 sm:space-y-0 sm:space-x-2 cursor-pointer sm:flex">
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2 text-center"><RxPerson size={17} /><h1 className="text-sm md:text-base font-semibold">1 Guest</h1></div>
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2"><LiaBedSolid size={17} /><h1 className="text-sm md:text-base font-semibold">1 Bedroom</h1></div>
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2"><PiBathtub size={17}/><h1 className="text-sm md:text-base font-semibold">1 Bathroom</h1></div>
                    </div>

                    <div className="my-12">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-5">About the cabin</h1>
                        <p className="text-base sm:text-lg text-[#5d5d5d] mb-8">Our Micro Cabin is the pinnacle of luxury. This suite offers breathtaking views of Mountain Dreamers Lodge from three bays.</p>

                        <p className="text-base sm:text-lg text-[#5d5d5d]"> It features a spacious living room, 1 master bedroom with a heater and a wifi etc, ensuring a truly opulent experience during your stay.</p>                      

                        <p className="text-base sm:text-lg text-[#5d5d5d] my-9">This suite can accommodate up to 1 guest or more and it's the best choice for the singles or couples.</p>
                    </div>
                    ...
                    <div className="py-10 px-9 border box-shadow rounded-3xl">
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                <p className="font-bold text-xl md:text-3xl">$ 79.00 USD</p>
                ...
                <div className="max-w-screen-xl mx-auto xl:px-5">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 mt-10 gap-x-7 gap-y-7">
                        <div className="h-[270px] sm:h-[300px] lg:h-[240px] ">
                            <img src={ micro_img1 } alt="img" className="h-full w-full rounded-3xl object-cover"/>
                        </div>
                        <div className="h-[270px] sm:h-[300px] lg:h-[240px]">
