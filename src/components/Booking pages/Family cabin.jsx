...
import family_img1 from '../../assets/family-img1.jpg'
...
const Family_cabin  = () => {
    ...
    return(
        <div className="text-black font-sans w-full">
            <div className="flex flex-col h-[75vh] md:h-screen family-header justify-end">
                <div className="flex  xl:px-5 mb-20">
                    <div className="text-white px-6 md:w-[85%] lg:w-[60%]">
                        <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl mb-8  ">Family Rustic Cabin</h1>
            ...
            <div className="max-w-screen-xl mx-auto px-6 xl:px-5 py-[9%] lg:flex h-full">
                <div className="w-full md:w-[90%] lg:w-[64%]">
                    <div className="w-full space-y-3 sm:space-y-0 sm:space-x-2 cursor-pointer sm:flex">
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2 text-center"><RxPerson size={17} /><h1 className="text-sm md:text-base font-semibold">8 Guests</h1></div>
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2"><LiaBedSolid size={17} /><h1 className="text-sm md:text-base font-semibold">4 Bedrooms</h1></div>
                        <div className="py-2 px-4 md:py-3 md:px-5 rounded-full justify-center border border-[#d7d5d5] flex items-center space-x-2"><PiBathtub size={17}/><h1 className="text-sm md:text-base font-semibold">4 Bathrooms</h1></div>
                    </div>

                    <div className="my-12">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-5">About the cabin</h1>
                        <p className="text-base sm:text-lg text-[#5d5d5d] mb-8">Our Family Cabin is the pinnacle of luxury. This suite offers breathtaking views of Mountain Dreamers Lodge from three bays.</p>

                        <p className="text-base sm:text-lg text-[#5d5d5d]"> It features a spacious living room, a dedicated dining room, 4 master bedrooms with a deep soaking hot tub and a separate shower etc, ensuring a truly opulent experience during your stay.</p>                      

                        <p className="text-base sm:text-lg text-[#5d5d5d] my-9">This suite can accommodate up to 8 guests or more and it's the best choice for the big size family.</p>
                    </div>
                    ...
                    <div className="py-10 px-9 border box-shadow rounded-3xl">
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                <p className="font-bold text-xl md:text-3xl">$ 399.00 USD</p>
            ...
            <div className="px-6 py-[12%] bg-[#fcfcfc]">
                <div className="max-w-screen-xl mx-auto xl:px-5">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 mt-10 gap-x-7 gap-y-7">
                        ...
                        <div className="h-[270px] sm:h-[300px] lg:h-[240px]">
                            <img src={ family_img1 } alt="img" className="h-full w-full rounded-3xl object-cover"/>
                        </div>
                        <div className="h-[270px] sm:h-[300px] lg:h-[240px] ">
